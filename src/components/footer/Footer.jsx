    ...
    <footer className="footer">
      ...
      <div className="footer-links-wrapper">
        ...
        <div className="footer-links-item">
          ...
          BOOK/SHOP is a design-minded, multi-disciplinary brand offering objects, events, and experiences related to books and reading.  Founded by Erik Heywood in 2023 and run by a small team in the North India Area.
          </p>
        </div>
      </div>
    </footer>
